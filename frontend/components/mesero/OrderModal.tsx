                          ...
                          return (
                            ...
                            `}
                              ...
                              >
                                ...
                                <div className={`absolute top-2 right-2 sm:top-3 sm:right-3 w-6 h-6 sm:w-8 sm:h-8 rounded-full flex items-center justify-center transition-all duration-300 ${isHovered ? 'bg-white/20 scale-110' : `bg-gradient-to-r ${categoryColors[category]} shadow-md`
                                  }`}>
                                ...
                                <div className="flex flex-col gap-1 sm:gap-2 pr-7 sm:pr-10 pt-1 sm:pt-2">
                                  <div className="flex items-center gap-1 sm:gap-2">
                                    <div className={`w-1.5 h-1.5 sm:w-2 sm:h-2 rounded-full transition-all duration-300 ${isHovered ? 'bg-white animate-pulse' : `bg-gradient-to-r ${categoryColors[category]}`
                                      }`} />
                                  ...
                                  <Badge
                                    ...
                                    className={`text-[10px] sm:text-xs w-fit px-1.5 sm:px-2 py-0.5 sm:py-1 transition-all duration-300 ${isHovered
                                  ...
                                  {categoryItems.length > 0 && (
                                    <p className={`text-[10px] sm:text-xs leading-relaxed font-medium transition-all duration-300 ${isHovered ? 'text-white/90' : 'text-gray-600'
                                      }`}>
                                ...
                                <div className="flex items-center justify-end mt-1 sm:mt-3">
                                  <Button
                                    ...
                                    className={`h-5 sm:h-7 px-2 sm:px-3 text-[10px] sm:text-xs transition-all duration-300 rounded-lg ${isHovered
                                ...
                                <div className={`absolute inset-0 rounded-xl transition-all duration-300 ${isHovered ? 'shadow-inner' : ''
                                  }`} />
                              </div>
                            </div>
                          )
                                ...
                                <div className="flex-1 min-w-0">
                                  <div className="flex items-center gap-2 mb-1">
                                    ...
                                    {order.status && (
                                      <Badge
                                        variant="outline"
                                        className={`text-xs px-2 py-0.5 ${order.status === 'pendiente'
